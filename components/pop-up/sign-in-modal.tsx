...
export default function SignInModal({ open, handleClose }: { open: boolean, handleClose: any }) {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (fetch?.result) {
            ...
            snackBarContext.setSnackBar({
                open: true,
                message: fetch?.message || "Sign in success",
                severity: "success",
                duration: 2000,
                vertical: "top",
                horizontal: "center",
                        ...
                        <div className="w-full relative bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <form className="space-y-4 md:space-y-6">
                                    ...
                                    <button onClick={handleSubmit} type="submit" className="w-full text-white bg-[rgb(var(--quaternary-rgb))] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign In</button>
