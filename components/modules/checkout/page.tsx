...
export default function Checkout() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center pt-4 pb-10 relative">
      <VoucherModal open={isVoucherPopupOpen} handleClose={handleCloseVoucherPopup} />
      <CategoryMenu />
      ...
      <div className="w-3/4 flex gap-4">
        <div className="w-3/4 flex flex-col gap-4">
          <div className="w-full border border-gray-200 shadow-md rounded-md">
            <div className="p-4">
              <h1 className="text-[18px] font-semibold">Choose the Protocol Protocol</h1>
              <div>
                <div className="">
                  <div className="bg-gray-100 p-4 rounded-lg border border-gray-300 mt-4 mb-4">
                    <div className="flex items-center">
                      <input type="radio" name="deliveryOption" className="form-radio h-5 w-5 text-blue-600" />
                      <div className="ml-2">
                        <span className="text-sm font-semibold ml-1">Express delivery</span>
                        <span className="ml-2 bg-[rgb(var(--quaternary-rgb))] text-white py-1 px-3 rounded-full text-xs">- $15</span>
                      </div>
                      <div className="flex-1 text-right">
                        <span className="text-xs">Supports 2 products for this option</span>
                      </div>
                    </div>
                  </div>
                </div>
                            ...
                            <div className="bg-white p-4 rounded-lg border border-gray-100">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                  <div className="mr-4 p-1 bg-gray-200 rounded-lg">
                                    <img src={item?.product?.thumbnail[0]?.link} alt="img" width={60} className="rounded-md" />
                                  </div>
                              ...
                              <div className="mt-4 flex items-center justify-between">
                                <div className="flex items-center space-x-2">
                                  ...
                                  <p className="text-sm text-gray-700">Delivered tomorrow, before 7pm, May 17</p>
                                </div>
                                <div className="text-sm bg-blue-100 text-[rgb(var(--quaternary-rgb))] py-1 px-3 rounded-full">
                                  Delivered by KIOTFPT Smart Logistics (delivered from Can Tho)
                                </div>
                              </div>
                            </div>
                          </div>
          ...
          <div className="w-full border border-gray-200 shadow-md rounded-md">
            <div className="p-4">
              <h1 className="text-[18px] font-semibold">Choose the delivery addresses</h1>
              <div>
                <div className="">
                  <div className="bg-gray-100 p-4 rounded-lg border border-gray-300 mt-4 mb-4">
                    <div className="flex items-center">
                      <input type="radio" name="deliveryOption" className="form-radio h-5 w-5 text-blue-600" />
                      <div className="ml-2">
                        <span className="text-sm font-semibold ml-1">200 Tô Vĩnh Diện, Long Tuyền, Bình Thuỷ, Cần Thơ</span>
                        <span className="ml-2 bg-[rgb(var(--quaternary-rgb))] text-white py-1 px-3 rounded-full text-xs">default</span>
                      </div>
                      <div className="flex-1 text-right">
                        <span className="text-xs font-bold text-[rgb(var(--quaternary-rgb))] cursor-pointer">Change</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="w-full border border-gray-200 shadow-md rounded-md">
            <div className="p-4">
              <h1 className="text-[18px] font-semibold">Choose a payment method</h1>
              <div>
                <div className="">
                  <div className="bg-gray-100 p-4 rounded-lg border border-gray-300 mt-4 mb-4">
                    <div className="flex items-center">
                      <input type="radio" name="deliveryOption" className="form-radio h-5 w-5 text-blue-600" />
                      <div className="ml-2">
                        <span className="text-sm font-semibold ml-1">Payment on delivery</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="w-1/4 h-full p-4 border border-gray-200 shadow-md rounded-md flex flex-col gap-4">
          <div className="flex justify-between items-center">
            ...
            <button onClick={handleOpenVoucherPopup} className="bg-[rgb(var(--quaternary-rgb))] py-1 px-4 rounded-md text-white font-semibold">Voucher</button>
          </div>
          <Divider />
          <div className="flex justify-between items-center">
            <h1>Subtotal</h1>
          ...
          <button className="w-full bg-[rgb(var(--primary-rgb))] py-2 rounded-md text-white font-semibold text-[16px]">Submit</button>
        </div>
      </div>
    </div>
  );
